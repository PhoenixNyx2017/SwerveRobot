...
public class DecreaseEncoderTic extends CommandBase {
  SwerveMotorTuner sMotorTuner;

  /** Creates a new DecreaseEncoderTic. */
  public DecreaseEncoderTic(SwerveMotorTuner sMotorTuner) {
  ...
  @Override
  public void execute() {
    sMotorTuner.decreaseEncoderTic();
